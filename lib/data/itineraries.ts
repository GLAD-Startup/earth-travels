  ...
  dubai: {
    ...
    days: [
      ...
      },
      {
        ...
        tag: "TRANSIT TO MALAYSIA",
        tagline: "Fly out of Dubai and touch down in Malaysia's vibrant capital.",
        activities: [
          { icon: "✈️", title: "Fly to Kuala Lumpur (KUL)", description: "Board your direct flight to Malaysia." },
          { icon: "🏨", title: "Hotel Check-In KL", description: "Transfer to your luxury hotel located near the Bukit Bintang shopping hub." },
        ],
        tip: "Malaysia has a tropical, humid climate; keep light cotton clothes handy.",
        image: "https://images.unsplash.com/photo-1525625293386-3f8f99389edd?auto=format&fit=crop&w=1200&q=80",
      },
      {
        dayNumber: 5,
        title: "Batu Caves & KL Towers",
        tag: "KUALA LUMPUR SIGHTS",
        tagline: "Climb the colorful steps of Batu Caves and gaze at the Twin Towers.",
        activities: [
          { icon: "⛰️", title: "Batu Caves Temple", description: "Climb the 272 vibrant, rainbow-colored steps to the temple cave guarded by Lord Murugan." },
          { icon: "🏢", title: "Petronas Twin Towers Skybridge", description: "Walk across the bridge connecting the world's tallest twin towers." },
        ],
        tip: "Ensure your knees and shoulders are covered when entering the Batu Caves temple complex.",
        image: "https://images.unsplash.com/photo-1596422846543-75c6fc18a52b?auto=format&fit=crop&w=1200&q=80",
      },
      {
        dayNumber: 6,
        title: "Genting Highlands Escape",
        tag: "HILL RETREAT",
        tagline: "Cool mountain breezes, indoor theme parks, and a cable car ride above the clouds.",
        activities: [
          { icon: "🚡", title: "Awana Skyway Cable Car", description: "Ride the gondola up to Genting Highlands, stopping at the Chin Swee Caves Temple." },
          { icon: "🎰", title: "Genting Theme Parks & Resort", description: "Spend the day enjoying rides, shopping malls, and indoor entertainment zones." },
        ],
        tip: "Bring a light jacket as temperatures at Genting are much cooler than KL (around 18°C).",
        image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1200&q=80",
      },
      {
        dayNumber: 7,
        ...
        tag: "SHOPPING SPARK",
        tagline: "Explore the massive malls of Pavilion and sample diverse street food.",
        activities: [
          { icon: "🛍️", title: "Bukit Bintang Mall Hopping", description: "Visit Pavilion, Lot 10, and Berjaya Times Square for tax-free shopping." },
          { icon: "🍜", title: "Jalan Alor Food Street", description: "Dine on authentic Malaysian satay, dim sum, and seafood at the famous night food market." },
        ],
        tip: "Jalan Alor gets extremely busy after 7 PM; hold onto your belongings and carry cash.",
        image: "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?auto=format&fit=crop&w=1200&q=80",
      },
      {
        dayNumber: 8,
        ...
        tag: "MEMORIAL EVENT",
        tagline: "A beautiful dinner overlooking the illuminated city skyline.",
        activities: [
          { icon: "🍽️", title: "Atmosphere 360 Buffet Dinner", description: "Dine in style at the revolving restaurant inside KL Tower with stunning panoramic views." },
        ],
        tip: "A smart-casual dress code is strictly enforced at Atmosphere 360.",
        image: "https://images.unsplash.com/photo-1598091383021-15ddea10925d?auto=format&fit=crop&w=1200&q=80",
      },
      {
        dayNumber: 9,
        ...
        tag: "DEPARTURE",
        tagline: "End of your dual-country tour. Return to Mathura/Delhi.",
        activities: [
          { icon: "✈️", title: "KLIA Airport Drop", description: "Transfer to Kuala Lumpur International Airport for your departure flight home." },
        ],
        tip: "Confirm that you have exchanged any remaining Ringgit or Dirhams back to INR at the airport.",
        image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1200&q=80",
      },
    ],
    hotels: [
