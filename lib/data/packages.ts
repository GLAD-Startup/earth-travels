...
export const PACKAGES: Package[] = [
  ...
  // ── KERALA ──
  {
    ...
    destination: "Kerala",
    destinationId: "kerala",
    name: "Kerala Backwaters & Houseboat Cruise (Alleppey & Kumarakom)",
    duration: { nights: 5, days: 6 },
    pricePerPerson: 19500,
    category: ["nature", "family"],
    image: "/images/destinations/kerala_1.jpg",
    highlights: ["Overnight Luxury Houseboat Cruise", "Kumarakom Bird Sanctuary Kayaking", "Marari Beach Sunset Walk"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Backwater Favorite",
    itineraryPage: "/itinerary/kerala-backwaters",
  },
  {
    id: "kerala-hills-wildlife",
    destination: "Kerala",
    destinationId: "kerala",
    name: "Kerala Misty Tea Hills & Wildlife Safari (Munnar & Thekkady)",
    duration: { nights: 4, days: 5 },
    pricePerPerson: 17500,
    category: ["nature", "adventure"],
    image: "/images/destinations/kerala_2.jpg",
    highlights: ["Munnar Tea Plantation Estate Tour", "Periyar National Park Bamboo Rafting", "Kathakali & Kalaripayattu Cultural Show"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Misty Hills",
    itineraryPage: "/itinerary/kerala-hills-wildlife",
  },
  {
    id: "kerala-luxury",
    destination: "Kerala",
    destinationId: "kerala",
    name: "Kerala Royal Ayurvedic Wellness & Backwater Retreat",
    duration: { nights: 6, days: 7 },
    pricePerPerson: 38000,
    category: ["luxury", "honeymoon"],
    image: "/images/destinations/kerala_3.jpg",
    highlights: ["Kumarakom Lake Resort Pool Villa", "Private Ayurvedic Rejuvenation Spa", "Vembanad Lake Sunset Private Cruise"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Wellness Luxury",
    itineraryPage: "/itinerary/kerala-luxury",
  },
