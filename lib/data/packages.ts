...
export const PACKAGES: Package[] = [
  ...
  },
  {
    ...
    pricePerPerson: 38000,
    category: ["adventure", "nature"],
    image: "/images/destinations/oman.avif",
  ...
  },
  {
    ...
    pricePerPerson: 68000,
    category: ["luxury", "honeymoon"],
    image: "/images/destinations/qatar1.webp",
  ...
  },
  {
    ...
    category: ["budget", "family"],
    image: "/images/destinations/Qatar2.webp",
  ...
  // ── HONG KONG ──
  {
    ...
    name: "Hong Kong Skyline & Disneyland Highlights",
    duration: { nights: 4, days: 5 },
    pricePerPerson: 52000,
    category: ["family", "culture"],
    image: "/images/destinations/hong_kong_1.jpg",
    highlights: ["Victoria Harbour Star Ferry & Symphony of Lights", "Disneyland Hong Kong Day Pass", "Victoria Peak Tram & Sky Terrace 428"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Family Choice",
    itineraryPage: "/itinerary/hong-kong-express",
  },
  {
    id: "hong-kong-luxury",
    destination: "Hong Kong",
    destinationId: "hong-kong",
    name: "Hong Kong Luxury Skyline & Peninsula Helicopter Tour",
    duration: { nights: 5, days: 6 },
    pricePerPerson: 88000,
    category: ["luxury", "honeymoon"],
    image: "/images/destinations/hong_kong_2.jpg",
    highlights: ["The Peninsula Victoria Harbour View Suite", "Private Helicopter Tour Over Hong Kong Island", "Michelin Star Dim Sum & Private Yacht Cruise"],
    inclusions: { flight: true, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Ultra Luxury",
    itineraryPage: "/itinerary/hong-kong-luxury",
  },
  {
    id: "hong-kong-macau-combo",
    destination: "Hong Kong",
    destinationId: "hong-kong",
    name: "Hong Kong & Macau Dual Heritage Explorer",
    duration: { nights: 6, days: 7 },
    pricePerPerson: 68000,
    category: ["culture", "family"],
    image: "/images/destinations/hong_kong_3.jpg",
    highlights: ["TurboJET High-Speed Ferry to Macau", "Ruins of St. Paul's & Venetian Macau", "Lantau Island Tian Tan Giant Buddha"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Dual Destination",
    itineraryPage: "/itinerary/hong-kong-macau-combo",
  },
  ...
  // ── MACAU ──
  {
    ...
    destination: "Macau",
    destinationId: "macau",
    name: "Macau Heritage & Cotai Strip Highlights",
    duration: { nights: 4, days: 5 },
    pricePerPerson: 45000,
    category: ["culture", "family"],
    image: "/images/destinations/macau_1.jpg",
    highlights: ["Ruins of St. Paul's UNESCO Historic Centre", "The Venetian Macau Gondola Ride", "Macau Tower Observation Deck"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Heritage Choice",
    itineraryPage: "/itinerary/macau-4n5d",
  },
  {
    id: "macau-luxury",
    destination: "Macau",
    destinationId: "macau",
    name: "Macau Ultra-Luxury Casino & Resort Escape (The Londoner & Wynn Palace)",
    duration: { nights: 5, days: 6 },
    pricePerPerson: 79000,
    category: ["luxury", "honeymoon"],
    image: "/images/destinations/macau_2.jpg",
    highlights: ["Wynn Palace SkyCab Cable Car & Performance Lake", "The Londoner Macau Suites", "Michelin Dining at Robuchon au Dôme"],
    inclusions: { flight: true, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Ultra Luxury",
    itineraryPage: "/itinerary/macau-luxury",
  },
  {
    id: "macau-adventure",
    destination: "Macau",
    destinationId: "macau",
    name: "Macau Thrill & Coastal Heritage (Macau Tower Skywalk & Coloane Village)",
    duration: { nights: 3, days: 4 },
    pricePerPerson: 38000,
    category: ["adventure", "nature"],
    image: "/images/destinations/macau_3.jpg",
    highlights: ["Macau Tower AJ Hackett Bungee & Skywalk", "Coloane Village Lord Stow's Egg Tarts", "Hac Sa Black Sand Beach Sunset Walk"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Thrill Pick",
    itineraryPage: "/itinerary/macau-adventure",
  },
  ...
  // ── MEGHALAYA ──
  {
    ...
    name: "Meghalaya Clouds & Living Root Bridges (Shillong, Cherrapunji & Dawki)",
    duration: { nights: 5, days: 6 },
    pricePerPerson: 18500,
    category: ["nature", "family"],
    image: "/images/destinations/meghalaya_1.jpg",
    highlights: ["Double Decker Living Root Bridge Hike", "Dawki Umngot River Crystal Boat Ride", "Nohkalikai & Seven Sisters Waterfalls"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Nature Special",
    itineraryPage: "/itinerary/meghalaya-explorer",
  },
  {
    id: "meghalaya-adventure",
    destination: "Meghalaya",
    destinationId: "meghalaya",
    name: "Meghalaya Cave Explorer & Canyoning Adventure",
    duration: { nights: 4, days: 5 },
    pricePerPerson: 22000,
    category: ["adventure", "nature"],
    image: "/images/destinations/meghalaya_2.jpg",
    highlights: ["Mawsmai & Arwah Cave Exploration", "Wei Sawdong Three-Tiered Waterfall Trek", "Kongthong Whistling Village Tour"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Adventure Pick",
    itineraryPage: "/itinerary/meghalaya-adventure",
  },
  {
    id: "meghalaya-luxury",
    destination: "Meghalaya",
    destinationId: "meghalaya",
    name: "Meghalaya Luxury Pine Retreat & Resort Escape",
    duration: { nights: 6, days: 7 },
    pricePerPerson: 34500,
    category: ["luxury", "honeymoon"],
    image: "/images/destinations/meghalaya_3.jpg",
    highlights: ["Ri Kynjai Resort Umiam Lake View", "Private Cherrapunji Valley Helicopter Tour", "Dawki Luxury Glamping & Private Boat"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Luxury Escape",
    itineraryPage: "/itinerary/meghalaya-luxury",
  },
  ...
  // ── BHUTAN ──
  {
    ...
    name: "Bhutan Thunder Dragon Highlights (Paro, Thimphu & Punakha)",
    duration: { nights: 5, days: 6 },
    pricePerPerson: 38500,
    category: ["culture", "family"],
    image: "/images/destinations/bhutan_1.jpg",
    highlights: ["Tiger's Nest (Taktsang Monastery) Cliff Trek", "Punakha Dzong Golden Valley View", "Thimphu Buddha Dordenma Statue"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Bhutan Bestseller",
    itineraryPage: "/itinerary/bhutan-5n6d",
  },
  {
    id: "bhutan-luxury",
    destination: "Bhutan",
    destinationId: "bhutan",
    name: "Bhutan Ultra-Luxury Amankora & Six Senses Sanctuary",
    duration: { nights: 6, days: 7 },
    pricePerPerson: 115000,
    category: ["luxury", "honeymoon"],
    image: "/images/destinations/bhutan_2.jpg",
    highlights: ["Amankora Paro & Thimphu Luxury Lodge Stay", "Private Monastic Blessing & Butter Lamp Ceremony", "Dotsho Traditional Hot Stone Bath"],
    inclusions: { flight: true, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Ultra Luxury",
    itineraryPage: "/itinerary/bhutan-luxury",
  },
  {
    id: "bhutan-trek",
    destination: "Bhutan",
    destinationId: "bhutan",
    name: "Bhutan Himalayan Valley & Tiger's Nest Adventure",
    duration: { nights: 4, days: 5 },
    pricePerPerson: 32000,
    category: ["adventure", "nature"],
    image: "/images/destinations/bhutan_3.jpg",
    highlights: ["Taktsang Monastery Tiger's Nest Hike", "Dochula Pass 108 Memorial Stupas", "Phobjikha Valley Black-Necked Crane Sanctuary"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Himalayan Pick",
    itineraryPage: "/itinerary/bhutan-trek",
  },
  ...
  // ── NEPAL ──
  {
    ...
    destination: "Nepal",
    destinationId: "nepal",
    name: "Nepal Himalayan Highlights (Kathmandu, Pokhara & Nagarkot)",
    duration: { nights: 5, days: 6 },
    pricePerPerson: 28500,
    category: ["culture", "family"],
    image: "/images/destinations/nepal_1.jpg",
    highlights: ["Boudhanath Stupa & Pashupatinath Temple", "Sarangkot Sunrise Mountain View", "Phewa Lake Pokhara Boat Ride"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Himalayan Pick",
    itineraryPage: "/itinerary/nepal-explorer",
  },
  {
    id: "nepal-adventure",
    destination: "Nepal",
    destinationId: "nepal",
    name: "Nepal Everest View & Annapurna Base Camp Trek",
    duration: { nights: 6, days: 7 },
    pricePerPerson: 42000,
    category: ["adventure", "nature"],
    image: "/images/destinations/nepal_2.jpg",
    highlights: ["Mount Everest Mountain Flight", "Annapurna Poon Hill Sunrise Trek", "Trishuli River White Water Rafting"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Adventure Special",
    itineraryPage: "/itinerary/nepal-adventure",
  },
  {
    id: "nepal-luxury",
    destination: "Nepal",
    destinationId: "nepal",
    name: "Nepal Luxury Himalayan Resort & Chitwan Wildlife Safari",
    duration: { nights: 6, days: 7 },
    pricePerPerson: 68000,
    category: ["luxury", "honeymoon"],
    image: "/images/destinations/nepal_3.jpg",
    highlights: ["Dwarika's Heritage Hotel Kathmandu", "Chitwan National Park Jungle Rhino Safari", "Private Helicopter Everest Base Camp Flyover"],
    inclusions: { flight: true, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Ultra Luxury",
    itineraryPage: "/itinerary/nepal-luxury",
  },
  ...
  // ── OOTY ──
  {
    ...
    destination: "Ooty",
    destinationId: "ooty",
    name: "Ooty Queen of Hills & Nilgiri Toy Train",
    duration: { nights: 4, days: 5 },
    pricePerPerson: 14500,
    category: ["family", "nature"],
    image: "/images/destinations/ooty_1.jpg",
    highlights: ["UNESCO Nilgiri Mountain Toy Train Ride", "Ooty Lake Boating & Botanical Gardens", "Doddabetta Peak 360 Viewpoint"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Hill Station Favorite",
    itineraryPage: "/itinerary/ooty-express",
  },
  {
    id: "ooty-nature",
    destination: "Ooty",
    destinationId: "ooty",
    name: "Ooty Tea Estates & Pykara Waterfalls Explorer",
    duration: { nights: 3, days: 4 },
    pricePerPerson: 12500,
    category: ["nature", "budget"],
    image: "/images/destinations/ooty_2.jpg",
    highlights: ["Tea Estate Walk & Tasting at Doddabetta", "Pykara Waterfalls & Speedboat Lake Ride", "Pine Forest & Shooting Point Sunset"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Nature Pick",
    itineraryPage: "/itinerary/ooty-nature",
  },
  {
    id: "ooty-luxury",
    destination: "Ooty",
    destinationId: "ooty",
    name: "Ooty Heritage Bungalow & Coonoor Luxury Escape",
    duration: { nights: 5, days: 6 },
    pricePerPerson: 29500,
    category: ["luxury", "honeymoon"],
    image: "/images/destinations/ooty_3.jpg",
    highlights: ["Savoy IHCL Heritage Hotel Stay", "Private Coonoor Sim's Park & Dolphin's Nose Tour", "Colonial High Tea & Private Cottage Garden"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Heritage Luxury",
    itineraryPage: "/itinerary/ooty-luxury",
  },

  // ── PONDICHERRY ──
  {
    id: "pondicherry-express",
    destination: "Pondicherry",
    destinationId: "pondicherry",
    name: "Pondicherry French Quarter & Coastal Heritage",
    duration: { nights: 4, days: 5 },
    pricePerPerson: 16500,
    category: ["culture", "family"],
    image: "/images/destinations/pondicherry_1.jpg",
    highlights: ["White Town French Architecture Walking Tour", "Promenade Beach Sunrise & Rock Beach Walk", "Auroville Matrimandir Visitor Pass"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "French Heritage",
    itineraryPage: "/itinerary/pondicherry-express",
  },
  {
    id: "pondicherry-surf-boho",
    destination: "Pondicherry",
    destinationId: "pondicherry",
    name: "Pondicherry Surfing, Paradise Beach & Boho Vibe",
    duration: { nights: 3, days: 4 },
    pricePerPerson: 13500,
    category: ["adventure", "budget"],
    image: "/images/destinations/pondicherry_2.jpg",
    highlights: ["Serenity Beach Surfing School Lesson", "Paradise Beach Boat Cruise", "French Cafe & Bakery Food Crawl"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Beach & Surf",
    itineraryPage: "/itinerary/pondicherry-surf-boho",
  },
  {
    id: "pondicherry-luxury",
    destination: "Pondicherry",
    destinationId: "pondicherry",
    name: "Pondicherry Villa Shanti & Luxury Colonial Haven",
    duration: { nights: 5, days: 6 },
    pricePerPerson: 28500,
    category: ["luxury", "honeymoon"],
    image: "/images/destinations/pondicherry_3.jpg",
    highlights: ["La Villa French Quarter Boutique Stay", "Private French Gastronomy Dining & Wine Tasting", "Auroville Private Meditation & Pottery Workshop"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Colonial Luxury",
    itineraryPage: "/itinerary/pondicherry-luxury",
  },

  // ── KENYA ──
  {
    id: "kenya-safari-5n6d",
    destination: "Kenya",
    destinationId: "kenya",
    name: "Kenya Masai Mara & Lake Nakuru Big Five Safari",
    duration: { nights: 5, days: 6 },
    pricePerPerson: 115000,
    category: ["adventure", "nature"],
    image: "/images/destinations/kenya_1.jpg",
    highlights: ["Masai Mara Big Five Game Drives", "Lake Nakuru Flamingo & Rhino Sanctuary", "Masai Cultural Village Experience"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Safari Bestseller",
    itineraryPage: "/itinerary/kenya-safari-5n6d",
  },
  {
    id: "kenya-luxury",
    destination: "Kenya",
    destinationId: "kenya",
    name: "Kenya Ultra-Luxury Giraffe Manor & Mara Serena Safari",
    duration: { nights: 6, days: 7 },
    pricePerPerson: 195000,
    category: ["luxury", "honeymoon"],
    image: "/images/destinations/kenya_3.jpg",
    highlights: ["Giraffe Manor Breakfast Experience", "Masai Mara Private Hot Air Balloon Safari", "Amboseli Kilimanjaro View Luxury Lodge"],
    inclusions: { flight: true, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Ultra Luxury",
    itineraryPage: "/itinerary/kenya-luxury",
  },
  {
    id: "kenya-amboseli",
    destination: "Kenya",
    destinationId: "kenya",
    name: "Kenya Amboseli Elephant & Great Rift Valley Trail",
    duration: { nights: 4, days: 5 },
    pricePerPerson: 98000,
    category: ["nature", "family"],
    image: "/images/destinations/kenya_2.jpg",
    highlights: ["Amboseli Kilimanjaro Backdrop Elephant Herds", "Lake Naivasha Boat Safari & Crescent Island Walk", "Great Rift Valley Viewpoint"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Wilderness Pick",
    itineraryPage: "/itinerary/kenya-amboseli",
  },
  ...
  // ── VARANASI ──
  {
    ...
    name: "Varanasi Sacred Ganges & Kashi Vishwanath Spiritual Tour",
    duration: { nights: 4, days: 5 },
    pricePerPerson: 15500,
    category: ["culture", "family"],
    image: "/images/destinations/varanasi_1.jpg",
    highlights: ["Dashashwamedh Ghat Evening Ganga Aarti VIP Seating", "Sunrise Boat Ride Past 84 Ghats", "Kashi Vishwanath Corridor & Sarnath Day Trip"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Spiritual Journey",
    itineraryPage: "/itinerary/varanasi-spiritual",
  },
  {
    id: "varanasi-express",
    destination: "Varanasi",
    destinationId: "varanasi",
    name: "Varanasi Ghats, Silk Bazaars & Heritage Walk",
    duration: { nights: 3, days: 4 },
    pricePerPerson: 12500,
    category: ["budget", "culture"],
    image: "/images/destinations/varanasi_2.jpg",
    highlights: ["Manikarnika & Assi Ghat Heritage Walk", "Banarasi Silk Weaving Village Tour", "Banaras Malaiyyo & Street Food Tasting"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Heritage Pick",
    itineraryPage: "/itinerary/varanasi-express",
  },
  {
    id: "varanasi-luxury",
    destination: "Varanasi",
    destinationId: "varanasi",
    name: "Varanasi BrijRama Palace Royal Heritage Experience",
    duration: { nights: 5, days: 6 },
    pricePerPerson: 32000,
    category: ["luxury", "honeymoon"],
    image: "/images/destinations/varanasi_3.jpg",
    highlights: ["BrijRama Palace 18th Century Ghats Hotel Stay", "Private Bajra Boat Sunrise & Sunset Cruise", "Private Classical Shehnai & Sitar Recital"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Palace Special",
    itineraryPage: "/itinerary/varanasi-luxury",
  },

  // ── MATHURA & VRINDAVAN ──
  {
    id: "mathura-spiritual",
    destination: "Mathura & Vrindavan",
    destinationId: "mathura-vrindavan",
    name: "Mathura & Vrindavan Sacred Pilgrimage Tour",
    duration: { nights: 3, days: 4 },
    pricePerPerson: 11500,
    category: ["culture", "family"],
    image: "/images/destinations/mathura_1.jpg",
    highlights: ["Shri Krishna Janmabhoomi Temple Darshan", "Bankey Bihari Temple VIP Darshan", "Prem Mandir Light & Sound Show"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Spiritual Journey",
    itineraryPage: "/itinerary/mathura-spiritual",
  },
  {
    id: "mathura-goverdhan",
    destination: "Mathura & Vrindavan",
    destinationId: "mathura-vrindavan",
    name: "Mathura, Vrindavan & Goverdhan Parikrama Trail",
    duration: { nights: 4, days: 5 },
    pricePerPerson: 14500,
    category: ["culture", "nature"],
    image: "/images/destinations/mathura_2.jpg",
    highlights: ["Goverdhan Hill Parikrama & Radha Kund", "Nandgaon & Barsana Radha Rani Temple", "Vishram Ghat Evening Yamuna Aarti"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Pilgrimage Special",
    itineraryPage: "/itinerary/mathura-goverdhan",
  },
  {
    id: "mathura-luxury",
    destination: "Mathura & Vrindavan",
    destinationId: "mathura-vrindavan",
    name: "Mathura Vrindavan Heritage Resort & VIP Temple Sanctuary",
    duration: { nights: 5, days: 6 },
    pricePerPerson: 26500,
    category: ["luxury", "family"],
    image: "/images/destinations/mathura_3.jpg",
    highlights: ["Nidhivan Sarovar Portico Luxury Resort Stay", "Private Yamuna Bajra Boat Sunrise Cruise", "Escorted VIP Puja & Prasadam at ISKCON Temple"],
    inclusions: { flight: false, hotel: true, meals: true, visa: false, transfers: true, sightseeing: true },
    badge: "Heritage Luxury",
    itineraryPage: "/itinerary/mathura-luxury",
  },
  ...
  // ── JAPAN ──
  {
    ...
    destination: "Japan",
    destinationId: "japan",
    name: "Japan Golden Route (Tokyo, Kyoto, Osaka & Mount Fuji)",
    duration: { nights: 6, days: 7 },
    pricePerPerson: 125000,
    category: ["culture", "family"],
    image: "/images/destinations/japan_1.jpg",
    highlights: ["Mount Fuji Lake Kawaguchiko View", "Fushimi Inari 10,000 Torii Gates", "Tokyo Shibuya Crossing & Skytree"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Bestseller",
    itineraryPage: "/itinerary/japan-golden-route",
  },
  {
    id: "japan-cultural-heritage",
    destination: "Japan",
    destinationId: "japan",
    name: "Japan Ancient Shrines, Geisha Traditions & Kyoto Temples",
    duration: { nights: 5, days: 6 },
    pricePerPerson: 145000,
    category: ["culture", "honeymoon"],
    image: "/images/destinations/japan_2.jpg",
    highlights: ["Fushimi Inari & Arashiyama Bamboo Grove", "Gion Geisha District Tea Ceremony", "Nara Deer Park Walking Tour"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Cultural Special",
    itineraryPage: "/itinerary/japan-cultural-heritage",
  },
  {
    id: "japan-tokyo-adventure",
    destination: "Japan",
    destinationId: "japan",
    name: "Japan Modern Tokyo Neon, Shibuya & Bullet Train Express",
    duration: { nights: 4, days: 5 },
    pricePerPerson: 98000,
    category: ["adventure", "group"],
    image: "/images/destinations/japan_3.jpg",
    highlights: ["Shibuya Crossing & Harajuku Street Tour", "Shinkansen Bullet Train Experience", "Tokyo Disneyland & Akihabara Electric Town"],
    inclusions: { flight: false, hotel: true, meals: true, visa: true, transfers: true, sightseeing: true },
    badge: "Modern Tokyo",
    itineraryPage: "/itinerary/japan-tokyo-adventure",
  },
];
