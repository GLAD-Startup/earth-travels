  ...
  return (
    <div className="bg-parchment min-h-screen text-espresso select-none">
      ...
      <section className="relative h-[60vh] min-h-[400px] w-full flex items-center justify-center text-center overflow-hidden border-b border-espresso/5">
        ...
        {/* Dark overlay grid */}
        <div className="absolute inset-0 bg-parchment/80 z-1 pointer-events-none" />

        {/* Title content */}
        <div className="max-w-4xl mx-auto px-6 relative z-10 mt-10">
          <RevealWrapper delay={0.1}>
            <h1 className="font-display text-4xl md:text-[72px] font-black leading-tight text-espresso mb-2 tracking-tight">
              From Mathura
            </h1>
          </RevealWrapper>
      ...
      {/* 2. Our Story Section */}
      <section className="max-w-7xl mx-auto px-6 py-24 border-b border-espresso/5 relative z-10">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 border-b border-espresso/5 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TESTIMONIALS.map((t, idx) => (
            <GlassCard
              key={idx}
              hover={false}
              className="p-6 md:p-8 bg-white/60 border border-espresso/10 rounded-[20px]"
            >
      ...
      {/* 7. Partner badges */}
      <section className="max-w-7xl mx-auto px-6 py-24 text-center border-b border-espresso/5 relative z-10">
        <h3 className="font-mono text-xs text-espresso/40 uppercase tracking-[0.25em] block mb-8 font-bold">
          Trusted & Certified
        </h3>
        <div className="flex flex-wrap gap-4 items-center justify-center opacity-65">
          {PARTNERS.map((badge, idx) => (
            <span
              key={idx}
              className="glass px-5 py-3 border border-espresso/10 rounded-xl bg-white/5 font-sans text-xs font-semibold text-espresso/80"
            >
              {badge}
            </span>
          ))}
      ...
      {/* 8. Closing CTA */}
      <section className="relative w-full py-16 px-6 overflow-hidden text-center bg-white/60 border-t border-espresso/5 flex items-center justify-center">
