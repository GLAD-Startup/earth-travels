...
export default function ItineraryPage() {
  ...
  if (!itinerary) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#080C14] text-white p-6">
        <div className="text-center max-w-md">
          ...
          <h2 className="font-display text-4xl font-bold text-white my-4">
          ...
          <div className="flex items-center gap-4 justify-center flex-wrap">
            ...
            <Link
              href="/contact"
              className="inline-block text-white/70 hover:text-white text-xs font-mono font-bold uppercase rounded-full px-6 py-2.5 border border-white/10 hover:border-white/30 transition-colors"
            >
              Contact Us
            </Link>
          </div>
    ...
    <div className="bg-[#080C14] min-h-screen text-white select-none">
      ...
      >
        <div className="max-w-7xl mx-auto w-full relative z-10 flex flex-col gap-6">
          ...
          <div>
            <h1 className="hero-slide-up font-display text-4xl md:text-[80px] font-normal italic text-white leading-none mb-2">
              {itinerary.tagline}
            </h1>
            <h2 className="hero-slide-up font-display text-2xl md:text-[48px] font-bold text-white/90 leading-none">
              {itinerary.title}
            </h2>
          </div>
          ...
          <div className="hero-slide-up glass p-5 rounded-2xl border border-white/10 max-w-4xl mt-4 bg-[#080C14]/50 backdrop-blur-md">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6 text-center md:divide-x divide-white/10 select-none">
              <div className="flex flex-col gap-1">
                <span className="text-white/40 font-sans text-[10px] uppercase">Duration</span>
              ...
              <div className="flex flex-col gap-1 pt-2 md:pt-0">
                <span className="text-white/40 font-sans text-[10px] uppercase">Origin</span>
                <span className="text-xs md:text-sm font-semibold font-mono text-white">Mathura / Delhi</span>
              </div>
              <div className="flex flex-col gap-1 pt-2 md:pt-0">
                <span className="text-white/40 font-sans text-[10px] uppercase">Group Size</span>
                <span className="text-xs md:text-sm font-semibold font-mono text-white">Max 20 People</span>
              </div>
              <div className="flex flex-col gap-1 pt-2 md:pt-0">
                <span className="text-white/40 font-sans text-[10px] uppercase">Meals</span>
                <span className="text-xs md:text-sm font-semibold font-mono text-white">Breakfast + Dinner</span>
              </div>
              <div className="flex flex-col gap-1 pt-2 md:pt-0">
                <span className="text-white/40 font-sans text-[10px] uppercase">Starting at</span>
      ...
      <div className="sticky top-[72px] z-30 w-full bg-[#080C14]/90 backdrop-blur-[24px] border-b border-white/5 py-3 px-6 text-center lg:hidden select-none">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <aside className="hidden lg:block w-40 shrink-0 sticky top-28 self-start">
            <h4 className="font-mono text-[10px] text-white/40 uppercase tracking-[0.2em] mb-5 font-bold">
              Progress Map
            </h4>
                  ...
                  >
                    <span
                      className={`w-5 h-5 rounded-full flex items-center justify-center font-mono text-[9px] font-bold border transition-all z-10 ${
                        isActive
                          ...
                          : "bg-midnight border-white/20 text-white/50 group-hover:border-white/50"
                      }`}
                    >
                      {day.dayNumber}
                    </span>
                    <span
                      className={`text-xs font-sans transition-colors duration-300 ${
                        isActive ? "text-[#D4A017] font-bold" : "text-white/50 group-hover:text-white"
                      }`}
                    >
                      Day {day.dayNumber}
                    </span>
          ...
          <div className="flex-grow w-full lg:max-w-[700px] flex flex-col gap-2">
            ...
            {itinerary.days.map((day) => (
              <div
                ...
                className="day-scroll-section relative pt-20 pb-10 border-b border-white/6 overflow-hidden flex flex-col gap-6"
              >
                {/* Day number watermark */}
                <div className="absolute top-8 left-[-10px] pointer-events-none select-none opacity-[0.04] z-0">
                  <span className="font-mono text-[120px] font-black leading-none text-white">
                ...
                <div className="relative z-10 pl-4 border-l-2 border-[#D4A017] mt-4 flex flex-col items-start gap-1">
                  ...
                  <h3 className="font-display text-3xl md:text-4xl font-normal text-white mt-1 leading-tight">
                    Day {day.dayNumber} — {day.title}
                  </h3>
                </div>

                {/* Tagline */}
                <p className="font-sans text-sm text-white/70 italic max-w-xl pl-4 relative z-10">
                  {day.tagline}
                </p>
                ...
                <div className="relative z-10 pl-4 flex flex-col gap-4 mt-2">
                  {day.activities.map((act, index) => (
                    <GlassCard
                      key={index}
                      hover={false}
                      className="p-4 bg-white/5 border border-white/5 hover:border-white/10 rounded-xl flex items-start gap-4 transition-colors"
                    >
                      ...
                      <div className="flex-grow">
                        <h4 className="font-sans text-[15px] font-semibold text-white leading-tight mb-1">
                          {act.title}
                        </h4>
                ...
                <div className="relative z-10 pl-4 mt-2">
                  <div className="p-4 border-l border-[#D4A017] bg-[#080C14]/60 backdrop-blur-md rounded-r-xl border-y border-r border-white/5 bg-gold/5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {itinerary.hotels.map((hotel, idx) => (
                  <GlassCard
                    key={idx}
                    hover={true}
                    className="p-0 overflow-hidden bg-midnight/35 border border-white/10 hover:border-[#D4A017]/30 transition-all duration-300 rounded-2xl flex flex-col justify-between group"
                  >
                    ...
                    <div className="p-4">
                      ...
                      <h4 className="font-sans text-sm font-bold text-white leading-tight mb-1">
                        {hotel.name}
                      </h4>
          ...
          <aside className="w-full lg:w-80 shrink-0 sticky top-28 self-start mt-12 lg:mt-0">
            <GlassCard hover={false} className="p-6 md:p-8 bg-[#080C14]/80 border border-white/10 shadow-2xl rounded-[20px] select-none">
              ...
              <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-[#D4A017] font-sans animate-none"
                    required
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-2">
                    <label className="font-mono text-[10px] text-white/50 uppercase tracking-widest pl-1">Adults</label>
                    <div className="flex items-center justify-between bg-white/5 border border-white/10 rounded-xl px-2 py-1 h-[40px]">
                      <button type="button" onClick={() => setAdults((prev) => Math.max(1, prev - 1))} className="w-6 h-6 rounded flex items-center justify-center hover:bg-white/10 text-white font-mono font-bold">-</button>
                      <span className="font-mono text-xs font-semibold text-white/80">{adults}</span>
                      <button type="button" onClick={() => setAdults((prev) => prev + 1)} className="w-6 h-6 rounded flex items-center justify-center hover:bg-white/10 text-white font-mono font-bold">+</button>
                    </div>
                  </div>

                  <div className="flex flex-col gap-2">
                    <label className="font-mono text-[10px] text-white/50 uppercase tracking-widest pl-1">Children</label>
                    <div className="flex items-center justify-between bg-white/5 border border-white/10 rounded-xl px-2 py-1 h-[40px]">
                      <button type="button" onClick={() => setChildren((prev) => Math.max(0, prev - 1))} className="w-6 h-6 rounded flex items-center justify-center hover:bg-white/10 text-white font-mono font-bold">-</button>
                      <span className="font-mono text-xs font-semibold text-white/80">{children}</span>
                      <button type="button" onClick={() => setChildren((prev) => prev + 1)} className="w-6 h-6 rounded flex items-center justify-center hover:bg-white/10 text-white font-mono font-bold">+</button>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col gap-2.5 mt-1 pl-1">
                    {[
                      ...
                      <label key={option.value} className="flex items-center gap-2.5 text-xs text-white/70 hover:text-white cursor-pointer select-none">
                        <input type="radio" name="room" checked={roomType === option.value} onChange={() => setRoomType(option.value)} className="sr-only" />
                        <span className={`w-3.5 h-3.5 rounded-full border flex items-center justify-center transition-colors ${roomType === option.value ? "border-[#D4A017] bg-[#D4A017]" : "border-white/20"}`}>
                          {roomType === option.value && <span className="w-1.5 h-1.5 rounded-full bg-midnight" />}
                        </span>
                ...
                <a
                  ...
                  className="text-center font-sans text-xs text-white/50 hover:text-white transition-colors block underline underline-offset-4 mt-1"
                >
                  or WhatsApp us →
                </a>
        ...
        <div className="pt-24 border-t border-white/5 mt-20">
          <h3 className="font-display text-3xl font-normal text-white mb-10 pl-4 border-l-2 border-[#D4A017]">
            You Might Also Love
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {relatedPackages.map((pkg, idx) => (
              <GlassCard
                key={idx}
                hover={true}
                className="p-0 overflow-hidden bg-midnight/35 border border-white/10 group rounded-2xl flex flex-col justify-between"
              >
                <div className="relative h-44 w-full overflow-hidden">
                  ...
                  <span className="absolute bottom-3 right-3 z-10 bg-midnight/80 border border-white/10 text-white font-mono text-[9px] px-2.5 py-1 rounded-full uppercase tracking-wider">
                ...
                <div className="p-5 flex-grow flex flex-col justify-between">
                  <div>
                    ...
                    <h4 className="font-sans text-base font-bold text-white mb-4 line-clamp-1 group-hover:text-[#D4A017] transition-colors leading-tight">
                      {pkg.name}
                    </h4>
                  </div>
                  ...
                  <div className="pt-3 border-t border-white/5 flex items-center justify-between mt-auto">
                    ...
                    <Link
                      ...
                      className="text-white text-xs font-mono group-hover:text-[#D4A017] flex items-center gap-0.5"
                    >
                      Explore →
                    </Link>
                  </div>
