...
export default function PackageSidebar({
  ...
  return (
    <aside className="w-full lg:w-72 shrink-0">
      <GlassCard hover={false} className="p-6 bg-midnight/30 border border-white/10 sticky top-24">
        <h4 className="font-mono text-xs text-gold uppercase tracking-[0.15em] font-bold border-b border-white/5 pb-4 mb-6">
          Filter Journeys
        </h4>

        <div className="mb-8">
          <div className="flex justify-between items-center mb-3">
            <label className="font-sans text-xs font-semibold text-white/80">Max Budget (per person)</label>
        ...
        <div className="mb-8">
          <label className="font-sans text-xs font-semibold text-white/80 block mb-3">
            Trip Duration
          </label>
          <div className="relative">
            ...
            >
              <option value="all" className="bg-[#080C14] text-white">All Durations</option>
              <option value="short" className="bg-[#080C14] text-white">Short (3 – 5 Nights)</option>
              <option value="medium" className="bg-[#080C14] text-white">Medium (6 – 8 Nights)</option>
              <option value="long" className="bg-[#080C14] text-white">Long (9+ Nights)</option>
            </select>
                  ...
                  <span
                    className={`w-4 h-4 rounded border transition-all flex items-center justify-center ${
                      isChecked
                        ...
                        : "border-white/20 group-hover:border-gold/50 bg-white/5"
                    }`}
                  >
