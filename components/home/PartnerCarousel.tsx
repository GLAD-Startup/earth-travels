...
export const PARTNERS: Partner[] = [
  ...
  { name: "Marriott",           logo: "/logos/marriott.jpg",          category: "hotel",     accentColor: "#8A1538" },
  ...
  { name: "Ritz-Carlton",       logo: "/logos/the-ritz-carlton-logo-png-transparent.png", category: "hotel", accentColor: "#002D62" },
  { name: "Rosewood Hotels",    logo: "/logos/rosewood.png",          category: "hotel",     accentColor: "#221E1F" },
  { name: "Centara Hotels",     logo: "/logos/centara-hotel-group-logo-png_seeklogo-344958.png", category: "hotel", accentColor: "#0F2C59" },
  { name: "Hilton Hotels",      logo: "/logos/Hilton-logo-2026-1-600x500.jpg", category: "hotel",     accentColor: "#003F87" },
  { name: "Hyatt Hotels",       logo: "/logos/Hyatt-Logo.wine.png",    category: "hotel",     accentColor: "#1A3263" },
  { name: "Sheraton",           logo: "/logos/sheraton-hotels-logo-11529406977kvwmlh14rx.png", category: "hotel", accentColor: "#103E2B" },
  { name: "Shangri-La",         logo: "/logos/shangri-la-hotel-logo-transparent-png-7.png", category: "hotel", accentColor: "#B5924C" },
  { name: "Renaissance Hotels", logo: "/logos/renaissance-hotels-resorts-logo-black-and-white.png", category: "hotel", accentColor: "#1E1E1E" },
  { name: "Scandic Hotels",     logo: "/logos/scandic.png",            category: "hotel",     accentColor: "#E3001A" },
  { name: "Hampton by Hilton",  logo: "/logos/kisspng-hampton-by-hilton-hilton-hotels-resorts-hilton-w-hilton-college-5b2379b41737a9.0081611315290515720951.jpg", category: "hotel", accentColor: "#002D62" },
  { name: "DoubleTree by Hilton", logo: "/logos/kisspng-doubletree-by-hilton-chicago-magnificent-mile-doub-lynx-double-eleven-5b026e435af179.1602849415268859553725.jpg", category: "hotel", accentColor: "#3C2B22" },
  { name: "Holiday Inn",        logo: "/logos/holiday inn.jpg",        category: "hotel",     accentColor: "#008751" },
  { name: "Embassy Suites",     logo: "/logos/embassy suites.png",     category: "hotel",     accentColor: "#005A70" },
  { name: "Comfort Hotels",     logo: "/logos/comfort_new_logo.png",   category: "hotel",     accentColor: "#F15A22" },
  { name: "Hanting Inns",       logo: "/logos/hanting inns.png",       category: "hotel",     accentColor: "#004F9F" },
  { name: "Ji Hotel",           logo: "/logos/Ji Hotel.webp",          category: "hotel",     accentColor: "#C5A059" },
  // ── Platforms / Trust ─────────────────────────────────────────
