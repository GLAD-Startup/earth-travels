  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      ...
      <a
        ...
        className="relative z-10 flex items-center gap-2.5 bg-[#25D366]/85 backdrop-blur-[12px] border border-[#25D366]/30 rounded-full px-5 py-3 shadow-lg hover:scale-105 hover:shadow-[0_0_24px_rgba(37,211,102,0.4)] transition-all duration-300 group select-none text-white cursor-pointer"
      >
        {/* WhatsApp Icon wrapper with white background containing green icon */}
        <div className="w-5.5 h-5.5 rounded-full bg-white flex items-center justify-center shrink-0">
          <svg
