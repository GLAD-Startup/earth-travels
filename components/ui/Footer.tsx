      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="mt-2">
              <span className="inline-block px-3.5 py-1.5 border border-[#e8a820]/30 rounded-lg text-[10px] font-mono font-semibold text-[#e8a820] uppercase tracking-widest bg-[#e8a820]/5">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-5 text-lg">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-[#e8a820] transition-colors hover:scale-110" aria-label="Instagram">
