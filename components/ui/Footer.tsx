          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-5 text-lg">
                ...
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-[#1877F2] transition-colors hover:scale-110" aria-label="Facebook">
