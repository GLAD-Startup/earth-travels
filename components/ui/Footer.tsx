      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3.5 text-lg">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#e8a820] transition-colors" aria-label="Instagram">📸</a>
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#e8a820] transition-colors" aria-label="Facebook">👥</a>
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#e8a820] transition-colors" aria-label="YouTube">📺</a>
                <a href={`https://wa.me/${SITE_CONFIG.whatsapp}`} target="_blank" rel="noopener noreferrer" className="hover:text-[#e8a820] transition-colors" aria-label="WhatsApp">💬</a>
              </div>
            </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/50">
          ...
          <p className="font-sans">
            Designed with ♥ by{" "}
            <a href="https://glad.studio" className="text-[#e8a820] hover:text-[#f0c040] font-semibold transition-colors">Glad Studio</a>
          </p>
        </div>
      </div>
    </footer>
