      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="tel:8941881111" className="font-mono text-sm font-semibold text-[#e8a820] hover:text-[#f0c040] transition-colors mt-1 block">
              📞 89418 81111
            </a>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="mt-2">
              <a
                ...
                className="inline-block px-3.5 py-1.5 border border-[#e8a820]/30 hover:border-[#e8a820]/60 rounded-lg text-[10px] font-mono font-semibold text-[#e8a820] uppercase tracking-widest bg-[#e8a820]/5 hover:bg-[#e8a820]/10 transition-all duration-300"
              >
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-5 text-lg">
                <a href="https://instagram.com/earthtravels.in" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-[#e8a820] transition-colors hover:scale-110" aria-label="Instagram">
                ...
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-[#e8a820] transition-colors hover:scale-110" aria-label="Facebook">

                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-[#e8a820] transition-colors hover:scale-110" aria-label="YouTube">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                </a>
                <a href={`https://wa.me/${SITE_CONFIG.whatsapp}`} target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-[#e8a820] transition-colors hover:scale-110" aria-label="WhatsApp">
